...
package com.xolo.scanzxing.zxing;
...
import com.xolo.scanzxing.R;
import com.xolo.scanzxing.zxing.camera.CameraManager;
        ...
        switch (requestCode) {
            case 1:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    builder.setMessage("当前没有授权调用摄像头，将不能扫码，授权后需要重新进入");
                    builder.setNegativeButton("取消扫码", new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    builder.setPositiveButton("请求授权", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            getPermissions();
                        }
